...
const requestSummaryShape = z.object({
  ...
  // Named ingest_mode, not mode, because playlist_filters already carries a
  // `mode` of its own and the two mean unrelated things.
  ingest_mode: z.enum(["full", "incremental"]),
